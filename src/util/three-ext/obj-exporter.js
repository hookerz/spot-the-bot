import { Vector2, Vector3, Matrix3, Geometry, BufferGeometry, Mesh, Line} from 'three';
...
{
  const contents = objExporter.parse(object);
  window.requestFileSystem = window.requestFileSystem || window.webkitRequestFileSystem;
  window.requestFileSystem(window.TEMPORARY, contents.length*2, function(fs) {
    fs.root.getFile('export.obj', {create: true}, function(fileEntry) {
...
window.exportObject = exportObject;
