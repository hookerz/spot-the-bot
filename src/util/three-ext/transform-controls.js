// This is copied from https://github.com/mrdoob/three.js/blob/dev/examples/js/controls/TransformControls.js
// and updated to use ES6 modules. If there is an update, paste it below and find/remove all
// occurrences of the string "THREE." and fix the export.

import {

  Object3D, Matrix4, Vector3, Vector2, Euler, Quaternion, Mesh, Line,
  Geometry, BufferGeometry, Float32BufferAttribute, BoxGeometry, BoxBufferGeometry,
  CylinderGeometry, OctahedronGeometry, PlaneBufferGeometry, CylinderBufferGeometry,
  TorusBufferGeometry, FrontSide, DoubleSide, MeshBasicMaterial, LineBasicMaterial,
  Raycaster, PerspectiveCamera,
...
export const TransformControls = function ( camera, objects, domElement ) {
  ...
  function onPointerHover( event ) {
    ...
    _mouse.x = ( event.clientX / domElement.width ) * 2 - 1;
    _mouse.y = - ( event.clientY / domElement.height ) * 2 + 1;
