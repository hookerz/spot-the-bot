...
const wiggle02 = CustomWiggle.create ( "wiggle01", { wiggles: 6, amplitudeEase: Power4.easeOut } );
...
export default function ( mesh, bones, onComplete ) {
  ...
  const tl = new TimelineMax ( { repeat: 0, onComplete: onComplete} );
        ...
        tl.to ( rootRoot.rotation, 0.8, { y: -0.5, ease: wiggle02 }, 0.0 );
        /*
        tl.add ([
        ...
        */
        ...
        tl.add ((() => {
          ...
          const tl = new TimelineMax ();
                ...
                tl.staggerTo ( positions, 0.4, { y: spread * 0.0, ease: Elastic.easeOut.config ( 1.4, 0.6 ), overwrite: 1 }, 0.01 );
        ...
        tl.add ([
         ...
         TweenMax.to ( root.scale, 0.12, { x: 0.95, y: 0.95, z: 0.95, ease: Power2.easeOut } ),
